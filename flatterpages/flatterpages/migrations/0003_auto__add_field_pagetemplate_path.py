...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageTemplate.path'
        db.add_column('flatterpages_pagetemplate', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PageTemplate.path'
        db.delete_column('flatterpages_pagetemplate', 'path')
