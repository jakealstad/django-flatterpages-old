...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.user_template'
        db.alter_column('flatterpages_page', 'user_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flatterpages.UserTemplate'], null=True))
    models = {
        'auth.group': {
        ...
        'flatterpages.page': {
            ...
            'user_template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flatterpages.UserTemplate']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
