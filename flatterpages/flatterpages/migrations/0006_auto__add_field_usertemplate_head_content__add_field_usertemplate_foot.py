...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTemplate.head_content'
        db.add_column('flatterpages_usertemplate', 'head_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserTemplate.footer_content'
        db.add_column('flatterpages_usertemplate', 'footer_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserTemplate.head_content'
        db.delete_column('flatterpages_usertemplate', 'head_content')

        # Deleting field 'UserTemplate.footer_content'
        db.delete_column('flatterpages_usertemplate', 'footer_content')
