...
class Page(models.Model):
	...
	meta_description = models.TextField(max_length=155, blank=True, null=True)
	...
	page_template = models.ForeignKey(PageTemplate, on_delete=models.PROTECT)
	user_template = models.ForeignKey(UserTemplate, blank=True, null=True, on_delete=models.PROTECT)
